...
import com.cinntra.indo.adapters.MessageAdapter;
...
//        callContactApi(opportunityItem.getCardCode());
    ...
    private void showBottomSheet(int id,String name)
    {
        ...
        ReminderSelectionSheet bottomSheetFragment = new ReminderSelectionSheet(id,name, com.cinntra.indo.fragments.LeadFollowUpFragment.this);

...
public class CustomerLedgerRes implements Serializable
{
    ...
    public List<com.cinntra.indo.model.MonthGroupPurchaseList> getMonthGroupPurchaseList() {
        return MonthGroupPurchaseList;
    }

    public void setMonthGroupPurchaseList(List<com.cinntra.indo.model.MonthGroupPurchaseList> monthGroupPurchaseList) {
    ...
    public List<com.cinntra.indo.model.SalesList> getSalesList() {
        return SalesList;
    }

    public void setSalesList(List<com.cinntra.indo.model.SalesList> salesList) {
        SalesList = salesList;
    }

    public List<com.cinntra.indo.model.ReceiptList> getReceiptList() {
        return ReceiptList;
    }

    public void setReceiptList(List<com.cinntra.indo.model.ReceiptList> receiptList) {
        ReceiptList = receiptList;
    }

    public List<com.cinntra.indo.model.ReceivableList> getReceivableList() {
        return ReceivableList;
    }

    public void setReceivableList(List<com.cinntra.indo.model.ReceivableList> receivableList) {
        ReceivableList = receivableList;
    }

    public List<com.cinntra.indo.model.MonthGroupSalesList> getMonthGroupSalesList() {
        return MonthGroupSalesList;
    }

    public void setMonthGroupSalesList(List<com.cinntra.indo.model.MonthGroupSalesList> monthGroupSalesList) {
    ...
    public void setMonthGroupReceivableList(List<com.cinntra.indo.model.MonthGroupSalesList> monthGroupReceivableList) {
        MonthGroupReceivableList = monthGroupReceivableList;
    }

    public List<com.cinntra.indo.model.MonthGroupSalesList> getMonthGroupReceiptList() {
        return MonthGroupReceiptList;
    }

    public void setMonthGroupReceiptList(List<com.cinntra.indo.model.MonthGroupSalesList> monthGroupReceiptList) {
        MonthGroupReceiptList = monthGroupReceiptList;
    }

    public List<com.cinntra.indo.model.UnderList> getUnderList() {
        return UnderList;
    }

    public void setUnderList(List<com.cinntra.indo.model.UnderList> underList) {
        UnderList = underList;
    }

    public List<com.cinntra.indo.model.UnderList> getOverList() {
        return OverList;
    }

    public void setOverList(List<com.cinntra.indo.model.UnderList> overList) {
        OverList = overList;
    }

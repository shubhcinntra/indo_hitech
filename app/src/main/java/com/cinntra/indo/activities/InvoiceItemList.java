...
import com.cinntra.indo.adapters.Invoice_Item_Adapter;
...
import static com.cinntra.indo.activities.CreateContact.ITEMSCODE;
...
public class InvoiceItemList extends MainBaseActivity implements View.OnClickListener {
    ...
    private void setAdapter() {
        adapter = new Invoice_Item_Adapter(com.cinntra.indo.activities.InvoiceItemList.this, Globals.SelectedItems);
        itemsRecycler.setLayoutManager(new LinearLayoutManager(com.cinntra.indo.activities.InvoiceItemList.this, RecyclerView.VERTICAL,false));
    ...
    case R.id.back_press:
        ...
        case R.id.new_quatos:
            Intent intent = new Intent(com.cinntra.indo.activities.InvoiceItemList.this, ItemsList.class);
